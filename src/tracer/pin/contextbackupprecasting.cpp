      ...
      void setCurrentRegisterValue(const triton::arch::Register& reg, triton::uint512 value) {
        ...
        triton::utils::fromUintToBuffer(value, buffer);
          ...
          switch (reg.getId()) {
            ...
            case triton::arch::ID_REG_X86_SS:      PIN_SetContextRegval(const_cast<long unsigned int **> (tracer::pintool::context::lastContext), static_cast<REG>(REG_SEG_SS), reinterpret_cast<triton::uint8*>(buffer)); break;
            default:
          ...
          switch (reg.getId()) {
            ...
            case triton::arch::ID_REG_X86_ES:      PIN_SetContextRegval(tracer::pintool::context::lastContext, LEVEL_BASE::REG_SEG_ES, reinterpret_cast<triton::uint8*>(buffer)); break;
            case triton::arch::ID_REG_X86_FS:      PIN_SetContextRegval(tracer::pintool::context::lastContext, LEVEL_BASE::REG_SEG_FS, reinterpret_cast<triton::uint8*>(buffer)); break;
            case triton::arch::ID_REG_X86_GS:      PIN_SetContextRegval(const_cast<const long unsigned int**> (tracer::pintool::context::lastContext), REG_SEG_GS, reinterpret_cast<triton::uint8*>(buffer)); break;
            //modified the above line
            case triton::arch::ID_REG_X86_SS:      PIN_SetContextRegval(const_cast<const long unsigned int**>(tracer::pintool::context::lastContext), static_cast<REG>(LEVEL_BASE::REG_SEG_SS), reinterpret_cast<triton::uint8*>(buffer)); break;
            default:
              throw std::runtime_error("tracer::pintool::context::setCurrentRegisterValue(): Invalid register.");
          }
        #endif
